...
pub fn fill_monitor_grid_rect(
    ...
    let grid_row_start =
        (((iy0 - my0) as f32 / monitor_height as f32) * grid_rows as f32).floor() as isize;
    let grid_row_end =
        (((iy1 - my0) as f32 / monitor_height as f32) * grid_rows as f32).ceil() as isize - 1;
    let grid_col_start =
        (((ix0 - mx0) as f32 / monitor_width as f32) * grid_cols as f32).floor() as isize;
    let grid_col_end =
        (((ix1 - mx0) as f32 / monitor_width as f32) * grid_cols as f32).ceil() as isize - 1;
